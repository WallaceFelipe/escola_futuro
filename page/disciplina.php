...
if($_GET['deletar']){
	...
	$res = $conexao->execute("delete from disciplina where iddisciplina = '$prof'");
...
$alunos = $conexao->select('*')->from('disciplina')->executeNGet();
	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-heading">
				...
				<button type="button" onclick="location.href='index.php?p=dis_cadastrar';" class="btn btn-primary pull-right">Cadastrar</button>
