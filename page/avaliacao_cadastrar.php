							...
							<table class="table table-hover">
								...
								<tbody id='listaQuestao'>
									<?php foreach ($questoes as $questao) { ?>
										<tr>
											<td><input type="checkbox" name="questoes[]" value="<?php echo $questao['idquestao']; ?>"></td>
											<td><?php echo $questao['enunciado']; ?></td>
											<td><?php echo $questao['opcao1']; ?></td>
											<td><?php echo $questao['opcao2']; ?></td>
											<td><?php echo $questao['opcao3']; ?></td>
											<td><?php echo $questao['opcao4']; ?></td>
											<td><?php echo $questao['resposta']; ?></td>
										</tr>
									<?php }?>
								</tbody>
							</table>
